...
class DailyExpensesScreen extends StatefulWidget {
  ...
  @override
  State<DailyExpensesScreen> createState() => _State();
}

class _State extends State<DailyExpensesScreen> {
  int period = 2;
  @override
      ...
      slivers: [
        const SliverToBoxAdapter(
          child: CategoryHeader(
            ...
            value: '€ 0,00',
            subtitle: 'Questo mese · 0% rispetto al mese scorso',
          ),
        ),
        SliverToBoxAdapter(
          child: Padding(
