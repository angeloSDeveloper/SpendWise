...
class SubscriptionsScreen extends StatefulWidget {
  ...
  @override
  State<SubscriptionsScreen> createState() => _SubscriptionsState();
}

class _SubscriptionsState extends State<SubscriptionsScreen> {
  String filter = 'Tutti';
  @override
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SingleChildScrollView(
            ...
            child: Row(
              children: ['Tutti', 'Mensili', 'Annuali', 'Settimanali']
                  .map(
                    (x) => Padding(
        ...
        SliverFillRemaining(
          ...
          child: EmptyState(
            ...
            action: () => context.go('/subscriptions/add'),
          ),
        ),
      ],
    ),
