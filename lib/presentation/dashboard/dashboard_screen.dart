...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cards = [
      ('Spese quotidiane', AppColors.daily, Icons.receipt_long, '/daily'),
      (
        'Abbonamenti',
      ...
      ('Rate', AppColors.installment, Icons.credit_card, '/installments'),
      ('Veicolo', AppColors.vehicle, Icons.directions_car, '/vehicle'),
    ];
    return Scaffold(
      appBar: AppBar(
        title: Column(
              ...
              children: [
                ...
                const Card(
                  child: ListTile(
                    ...
                    title: Text('Nessuna scadenza imminente'),
                  ),
                ),
                ...
                const Card(
                  child: ListTile(
                    ...
                    title: Text('Nessuna transazione'),
                  ),
                ),
              ],
            ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => context.go('/daily/add'),
